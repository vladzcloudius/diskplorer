...
optparser.add_option('-o', '--output', dest='output_filename', default='disk-concurrency-response.json',
                     help='Write output JSON to FILE', metavar='FILE')
...
def run_job():
    ...
    open(output_filename, 'w').write(result_json)
